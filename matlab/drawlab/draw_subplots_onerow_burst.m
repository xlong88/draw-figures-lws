function draw_subplots_onerow_burst(datajsonfile, confjsonfile)
...
title_pos = {
    [tp_x lim_y(1, 2) + tp_constant * lim_y(1, 2)  0];
    [tp_x lim_y(2, 2) + tp_constant * lim_y(2, 2) 0];
    [tp_x lim_y(3, 2) + tp_constant * lim_y(3, 2) 0];
    [tp_x lim_y(4, 2) + tp_constant * lim_y(4, 2) 0];
    };
    else
        title_pos = {
    [tp_x lim_y(1, 2) + tp_constant   0];
    [tp_x lim_y(2, 2) + tp_constant  0];
    [tp_x lim_y(3, 2) + tp_constant  0];
    [tp_x lim_y(4, 2) + tp_constant  0];
    };
    end
end
